        ...
        <table id="example2" class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class=center>
                        <a class="btn btn-primary btn-block" href="{{url('Activity/'.$Activitytype->enc_id).'/edit'}}">Edit</a>
                    </td>
                    
                    <td class=center>
                        {!! Form::open(['route' => ['Activity.destroy', $Activitytype->enc_id], 'method' => 'POST','onsubmit' => 'return ConfirmDelete()'])  !!}
                        {!! csrf_field() !!}
